...
<head>
    <meta charset="utf-8">
    <title>Combination Tour - TRAVELER</title>
...
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3">
        <div class="text-center mb-3 pb-3">
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Combination Tours</h6>
            <h1>Explore Our Combination Tours</h1>
        </div>
        <div class="row">
