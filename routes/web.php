...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/view-package', function () {
        return view('admin-page.view_package');
    })->name('admin.view-package');
    ...
    Route::get('/admin/view-package', [PackageController::class, 'index'])->name('admin.view-package');
    ...
    Route::get('/admin/view-order', [BookingController::class, 'index'])->name('admin.view-order');
    ...
    //Route::delete('/bookings/{id}/delete', [BookingController::class, 'destroy'])->name('bookings.delete');
